...
#define MMC_RSP_ISW 	(1 << 5)		/* i'm not letting rsptyp's bits to go to waste */
#define MMC_RSP_HASDATA (1 << 6)		/* better do out of band signalling */
